package com.example.naiveui.view.chat.element.guroup_bar_chat;

import com.example.naiveui.util.AutoSizeTool;
...
public class ElementInfoBox {
    ...
    public Pane left(String userNickName, String userHead, String msg, Integer msgType) {
        ...
        head.setStyle(String.format("-fx-background-image: url('/com/example/chat/img/head/%s.png')", userHead));
        children.add(head);
        ...
        switch (msgType){
            ...
            case 1:
                ...
                infoContentFace.setStyle(String.format("-fx-background-image: url('/com/example/face/img/%s.png');-fx-background-position: center center;-fx-background-repeat: no-repeat;-fx-background-color: #ffffff;-fx-border-width: 0 1px 1px 0;-fx-border-radius: 2px;-fx-background-radius: 2px;", msg));
    ...
    public Pane right(String userNickName, String userHead, String msg, Integer msgType) {
        ...
        switch (msgType){
            ...
            case 1:
                ...
                infoContentFace.setStyle(String.format("-fx-background-image: url('/com/example/face/img/%s.png');-fx-background-position: center center;-fx-background-repeat: no-repeat;-fx-background-color: #9eea6a;-fx-border-width: 0 1px 1px 0;-fx-border-radius: 2px;-fx-background-radius: 2px;", msg));
                children.add(infoContentFace);
                break;
        }
        return pane;
