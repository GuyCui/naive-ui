...
public class FaceView {
    ...
    private void initFaces() {
        ...
        f01.setStyle("-fx-background-image: url('/com/example/face/img/f_01.png')");
        ...
        f02.setStyle("-fx-background-image: url('/com/example/face/img/f_02.png')");
        ...
        f03.setStyle("-fx-background-image: url('/com/example/face/img/f_03.png')");
        ...
        f04.setStyle("-fx-background-image: url('/com/example/face/img/f_04.png')");
        ...
        f05.setStyle("-fx-background-image: url('/com/example/face/img/f_05.png')");
        ...
        f11.setStyle("-fx-background-image: url('/com/example/face/img/f_11.png')");
        ...
        f12.setStyle("-fx-background-image: url('/com/example/face/img/f_12.png')");
        ...
        f13.setStyle("-fx-background-image: url('/com/example/face/img/f_13.png')");
        ...
        f14.setStyle("-fx-background-image: url('/com/example/face/img/f_14.png')");
        ...
        f15.setStyle("-fx-background-image: url('/com/example/face/img/f_15.png')");
        ...
        f21.setStyle("-fx-background-image: url('/com/example/face/img/f_21.png')");
        ...
        f22.setStyle("-fx-background-image: url('/com/example/face/img/f_22.png')");
        ...
        f23.setStyle("-fx-background-image: url('/com/example/face/img/f_23.png')");
        ...
        f24.setStyle("-fx-background-image: url('/com/example/face/img/f_24.png')");
        ...
        f25.setStyle("-fx-background-image: url('/com/example/face/img/f_25.png')");
